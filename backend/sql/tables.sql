...
ALTER TABLE "reviews"
    ADD CONSTRAINT "reviews_fk1" FOREIGN KEY ("creator_id") REFERENCES "users" ("id");
ALTER TABLE "reviews"
    ADD CONSTRAINT "reviews_fk2" FOREIGN KEY ("product_id") REFERENCES "products" ("id");
...
ALTER TABLE "orders"
    ADD CONSTRAINT "orders_fk2" FOREIGN KEY ("business_id") REFERENCES "businesses" ("id");
ALTER TABLE "orders"
    ADD CONSTRAINT "orders_fk3" FOREIGN KEY ("promocode_id") REFERENCES "promocodes" ("id");
ALTER TABLE "promocodes"
    ADD CONSTRAINT "promocodes_fk1" FOREIGN KEY ("creator_id") REFERENCES "businesses" ("id");
ALTER TABLE "promocodes"
    ADD CONSTRAINT "promocodes_fk2" FOREIGN KEY ("product_id") REFERENCES "products" ("id");
...
ALTER TABLE "promocode_discount"
    ADD CONSTRAINT "promocode_discount_fk0" FOREIGN KEY ("promocode_id") REFERENCES "promocodes" ("id");
ALTER TABLE "promo_quanity"
    ADD CONSTRAINT "promo_quanity_fk0" FOREIGN KEY ("promocode_id") REFERENCES "promocodes" ("id");
ALTER TABLE "promocode_date"
    ADD CONSTRAINT "promocode_date_fk0" FOREIGN KEY ("promocode_id") REFERENCES "promocodes" ("id");
...
ALTER TABLE "reviews_data"
    ADD CONSTRAINT "reviews_data_fk0" FOREIGN KEY ("id") REFERENCES "reviews" ("id");
